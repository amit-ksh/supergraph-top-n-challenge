...
func (ec *executionContext) __resolve_entities(ctx context.Context, representations []map[string]interface{}) []fedruntime.Entity {
	...
	resolveEntity := func(ctx context.Context, typeName string, rep map[string]interface{}, idx []int, i int) (err error) {
		...
		switch typeName {
		case "Thread":
			resolverName, err := entityResolverNameForThread(ctx, rep)
			if err != nil {
				return fmt.Errorf(`finding resolver for Entity "Thread": %w`, err)
			}
			switch resolverName {
			...
			case "findThreadByID":
				...
				if err != nil {
					return fmt.Errorf(`unmarshalling param 0 for findThreadByID(): %w`, err)
				}
				entity, err := ec.resolvers.Entity().FindThreadByID(ctx, id0)
				if err != nil {
					return fmt.Errorf(`resolving Entity "Thread": %w`, err)
				}
...
func entityResolverNameForThread(ctx context.Context, rep map[string]interface{}) (string, error) {
	for {
		var (
		...
		return "findThreadByID", nil
	}
	return "", fmt.Errorf("%w for Thread", ErrTypeNotFound)
}
